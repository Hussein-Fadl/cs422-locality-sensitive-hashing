...
class MainTest {
  ...
  def testAggregatorUpdate2() {
    ...
    val delta = Array((253, 2388429, Option[Double](5.0), 4.0, 1000000001))
  ...
  def testAggregatorUpdate3() {
    ...
    val delta1 = Array((253, 2388429, Option[Double](5.0), 4.0, 1000000001))

    aggregator.updateResult(delta1)

    val delta2 = Array((253, 2388429, Option[Double](4.0), 5.0, 1000000002))
  ...
  def testAggregatorUpdate4() {
    ...
    val delta2 = Array((253, 2388429, Option[Double](5.0), 4.0, 1000000002))
